					...
					<div className=" flex md:gap-16 justify-center flex-col-reverse md:flex-row">
						...
						<div className=" max-w-lg mb-20 flex items-center justify-around">
							<div className=" flex flex-col text-left max-w-lg md:mt-4 flex-wrap md:p-0">
								...
								<p className="text-[#00305a] text-sm md:text-xl">2022年7月11日，红杉中国首位数字员工Hóng正式亮相，她是奥森奥森小冰团队为红杉资本量身定制的数字人，基于深度神经网络渲染技术小样本学习，经过一周的训练期即诞生。结合奥森奥森小冰框架的全域能力，Hóng将不断成长，并在红杉资本各个业务流程中承担重要职责。</p>
							</div>
						</div>
					</div>
					...
					<div className=" flex gap-16 flex-col md:flex-row">
						<div className=" md:mb-20 flex items-center justify-around">
							<div className=" flex flex-col text-left max-w-lg mt-4 flex-wrap">
								...
								<p className="text-[#00305a] text-sm md:text-xl">奥森奥森小冰团队为著名经济学家郎咸平先生量身定制了数字孪生，将形象呈现与内容生产解耦，再经专业团队高效生产优质内容，即可在全球社交网络和媒体平台持续、稳定的输出观点与解读，以扩展所覆盖的用户层级与类型，从而大幅提升流量、IP影响力及商业收益。</p>
							</div>
						</div>
