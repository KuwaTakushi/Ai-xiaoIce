		...
		<div>
			...
			<div className=" text-center hidden md:block bg-white">
				...
				<div className="flex flex-col justify-center items-center w-72 shadow-md p-6 rounded-xl text-black">
					<Image className=" object-cover w-24 pb-4" src="/icon_1.png" alt="" width={80} height={80} />
					<h2 className=" font-bold text-xl ">便捷高效</h2>
					<p>用户可以通过手机扫描二维码或链接访问数字名片，获取联系方式、社交链接、个人简介等信息，省去了传统名片交换的繁琐步骤。</p>
				</div>
				<div className="flex flex-col justify-center items-center w-72 shadow-md p-6 rounded-xl text-black">
					<Image className=" object-cover w-24 pb-4" src="/icon_2.png" alt="" width={80} height={80} />
					<h2 className=" font-bold text-xl">个性化定制</h2>
					<p>奥森小冰支持用户根据自身需求和品牌形象定制数字名片，设计独特的风格和版面，展现个性魅力。</p>
				</div>
				<div className="flex flex-col justify-center items-center w-72 shadow-md p-6 rounded-xl text-black">
					<Image className=" object-cover w-24 pb-4" src="/icon_3.png" alt="" width={80} height={80} />
					<h2 className=" font-bold text-xl">环保节能</h2>
					<p>减少纸质名片的浪费，符合环保理念。</p>
				</div>
				<div className="flex flex-col justify-center items-center w-72 shadow-md p-6 rounded-xl text-black">
					<Image className=" object-cover w-24 pb-4" src="/icon_4.png" alt="" width={80} height={80} />
			...
			<div className=" md:hidden bg-slate-50 p-4">
				<Accordion  className=" bg-white ">
					<AccordionItem key="1"
						...
						startContent={
							<Image className=" object-cover w-8" src="/icon_1.png" alt="" width={80} height={80} />
						}
					>
					...
					<AccordionItem 
						...
						startContent={
							<Image className=" object-cover w-8" src="/icon_2.png" alt="" width={80} height={80} />
						}
					>
					...
					<AccordionItem 
						...
						startContent={
							<Image className=" object-cover w-8" src="/icon_3.png" alt="" width={80} height={80} />
						}
					>
					...
					<AccordionItem
						...
						startContent={
							<Image className=" object-cover w-8" src="/icon_4.png" alt="" width={80} height={80} />
						}
					>
